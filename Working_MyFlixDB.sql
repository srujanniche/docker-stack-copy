Changing Docker Volumes Default Location:

nano /lib/systemd/system/docker.service
ExecStart=/usr/bin/dockerd --data-root /mydocekrvolumes/ -H fd:// --containerd=/run/containerd/containerd.sock
...
--detach \
--name=mysql01 \
--env="MYSQL_ROOT_PASSWORD=India@123456" \
--publish :3306:3306 \
-v mysql:/var/lib/mysql mysql:latest
